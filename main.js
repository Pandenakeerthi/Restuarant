...
//     // Trigger the click event on a link or button for the login page
//     const loginLink = document.querySelector('#login'); // Replace with your selector
//     if (loginLink) {
//         loginLink.click(); // Simulates a user click to navigate
//     } else {
